...
<%
	...
	HashMap mqt = new CommDAO().getmap(id,"xuanzeti");
	//ldlbfz
     %>
<BODY>
...
border=0>
  ...
  <TR>
   ...
   <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"  class="newsline">  
      <tr>
		 <td width='11%'>科目：</td><td width='39%'><%=mqt.get("kemu")%></td><td width='11%'>题目：</td><td width='39%'><%=mqt.get("timu")%></td></tr><tr><td width='11%'>选项A：</td><td width='39%'><%=mqt.get("xuanxiangA")%></td><td width='11%'>选项B：</td><td width='39%'><%=mqt.get("xuanxiangB")%></td></tr><tr><td width='11%'>选项C：</td><td width='39%'><%=mqt.get("xuanxiangC")%></td><td width='11%'>选项D：</td><td width='39%'><%=mqt.get("xuanxiangD")%></td></tr><tr><td width='11%'>答案：</td><td width='39%'><%=mqt.get("daan")%></td><td>&nbsp;</td><td>&nbsp;</td></tr><tr><td colspan=4 align=center><input type=button name=Submit5 value=返回 onClick="javascript:history.back()" /><input type=button name=Submit52 value=打印 onClick="javascript:window.print()"  /></td></tr>
