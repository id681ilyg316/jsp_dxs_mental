         ...
         <td><table width="188" border="0" cellspacing="0" cellpadding="0">
             ...
             <tr>
               <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="menubg">
                   ...
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="kemuxinxi_add.jsp" target="right">科目信息添加</a></td>
                  </tr>
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="kemuxinxi_list.jsp" target="right">科目信息查询</a></td>
                  </tr>
         ...
         <td><table width="188" border="0" cellspacing="0" cellpadding="0">
             ...
             <tr>
               <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="menubg">
                   ...
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="xuanzeti_add.jsp" target="right">选择题添加</a></td>
                  </tr>
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="xuanzeti_list.jsp" target="right">选择题查询</a></td>
                  </tr>
         ...
         <td><table width="188" border="0" cellspacing="0" cellpadding="0">
             ...
             <tr>
               <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="menubg">
                   ...
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="jiaoshixinxi_add.jsp" target="right">教师信息添加</a></td>
                  </tr>
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="jiaoshixinxi_list.jsp" target="right">教师信息查询</a></td>
                  </tr>
         ...
         <td><table width="188" border="0" cellspacing="0" cellpadding="0">
             ...
             <tr>
               <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="menubg">
                   ...
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="xinwentongzhi_add.jsp?lb=健康资讯" target="right">健康资讯添加</a></td>
                  </tr>
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="xinwentongzhi_list.jsp?lb=健康资讯" target="right">健康资讯查询</a></td>
                  </tr>
