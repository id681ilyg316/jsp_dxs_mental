         ...
         <td><table width="188" border="0" cellspacing="0" cellpadding="0">
             ...
             <tr>
               <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="menubg">
                   ...
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="chengji_list2.jsp" target="right">心理测试成绩</a></td>
                  </tr>
         ...
         <td><table width="188" border="0" cellspacing="0" cellpadding="0">
             ...
             <tr>
               <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="menubg">
                   ...
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="liuyanban_list2.jsp" target="right">留言查询</a></td>
                  </tr>
