...
function gow()
{
	document.location.href="chengji_add.jsp?id=<%=id%>";
}
</script>
<!--hxsglxiangdxongjxs-->
 <% 
...
new CommDAO().insert(request,response,"chengji",ext,true,false,""); 
%>

  <body >
 <form  action="chengji_add.jsp?f=f&id=<%=id%>"  name="form1"  onsubmit="return checkform();">
  添加成绩:
  <br><br>
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">
		...
		<tr><td  width="200">性别：</td><td><input name='xingbie' type='text' id='xingbie' value='' onblur='' style='border:solid 1px #000000; color:#666666' /></td></tr>
		<tr><td  width="200">测试结果：</td><td><input name='ceshijieguo' type='text' id='ceshijieguo' value='' onblur='' style='border:solid 1px #000000; color:#666666' /></td></tr>
